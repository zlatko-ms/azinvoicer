...
class TestMappingModel(unittest.TestCase):
    ...
    def test_init_fromFile(self) -> None:
        ...
        self.assertEqual(
            mappingModel.getMandatoryColumnName(MandatoryFields.METER_NAME), "MeterName", "meterName mapping is accurate"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            mappingModel.getOptionalColumnName(OptionalFields.LOCATION), "Location", "location mapping is accurate"
        )
        self.assertEqual(
            mappingModel.getOptionalColumnName(OptionalFields.PART_NUMBER), "PartNumber", "partNumber mapping is accurate"
        )
        self.assertEqual(
    ...
    def test_list_mandatory(self) -> None:
        ...
        self.assertIn(
            mappingModel.getMandatoryColumnName(MandatoryFields.TAGS), mandatory, "tags is provided as mandatory field"
        )
        self.assertIn(
            mappingModel.getMandatoryColumnName(MandatoryFields.METER_CATEGORY), mandatory, "meterCategory mapping is"
        )
        self.assertIn(
    ...
    def test_list_optional(self) -> None:
        ...
        self.assertIn(
            mappingModel.getOptionalColumnName(OptionalFields.LOCATION), optional, "location is provided as optional field"
        )
        self.assertIn(
            mappingModel.getOptionalColumnName(OptionalFields.PART_NUMBER), optional, "partNumber is provided as optional field"
        )
        self.assertIn(
            mappingModel.getOptionalColumnName(OptionalFields.ADDITIONAL_INFO),
            optional,
